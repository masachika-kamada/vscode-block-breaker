...
2. Run the command: `Start Block Breaker Game`
3. Use the arrow keys or A/D to move the paddle
4. Press SPACE to start/pause the game
5. Break all blocks to win!
...
4. In the new window, open the Command Palette (`Ctrl+Shift+P`) and run "Start Block Breaker Game"
